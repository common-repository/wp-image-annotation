...
?>
 <div class="wrap">
<?php  echo "<h2>" . __( 'wp-Image-Annotation Settings', 'dia_trdom' ) . "</h2>"; ?>
<h2>
...
<?php if($tab == 'settings') {
		...
		if($_POST['dia_hidden'] == 'Y') {
			...
			update_option('wp_image_annotation_homepage', $dia_homepage);
			
			//show on archive page
			$dia_archive = $_POST['dia_archive'];
			update_option('wp_image_annotation_archive', $dia_archive);
			
			//post content wrapper
			$dia_csscontainer = $_POST['dia_csscontainer'];
			update_option('wp_image_annotation_postcontainer', $dia_csscontainer);
			
			//plugin status
			$dia_display = $_POST['dia_display'];
			update_option('wp_image_annotation_display', $dia_display);
			
			//admin only
			$dia_admin = $_POST['dia_admin'];
			update_option('wp_image_annotation_admin', $dia_admin);
			
			//comments thumbnail
			$dia_thumbnail = $_POST['dia_thumbnail'];
			update_option('wp_image_annotation_thumbnail', $dia_thumbnail);
			
			//image note gravatar
			$dia_gravatar = $_POST['dia_gravatar'];
			update_option('wp_image_annotation_gravatar', $dia_gravatar);
			
			//image note gravatar
			$dia_gravatardefault = $_POST['dia_gravatardefault'];
			update_option('wp_image_annotation_gravatar_deafult', $dia_gravatardefault);
			
			//wordpress comment
			$dia_comments = $_POST['dia_comments'];
			update_option('wp_image_annotation_comments', $dia_comments);
			
			//auto insert image id
			$dia_autoimageid = $_POST['dia_autoimageid'];
			update_option('wp_image_annotation_autoimageid', $dia_autoimageid);
			
			//mouse over desc
			$dia_mouseoverdesc = $_POST['dia_mouseoverdesc'];
			update_option('wp_image_annotation_mouseoverdesc', $dia_mouseoverdesc);
			
			//link desc
			$dia_linkdesc = $_POST['dia_linkdesc'];
			update_option('wp_image_annotation_linkdesc', $dia_linkdesc);
			
			//post ID
			$dia_postid = $_POST['dia_postid'];
			update_option('wp_image_annotation_postid', $dia_postid);
			
			//admin only
			$dia_imgtag = $_POST['dia_imgtag'];
			update_option('wp_image_annotation_dia_imgtag', $dia_imgtag);
			...
			//Normal page display
			$dia_csscontainer = get_option('wp_image_annotation_postcontainer');
			$dia_display = get_option('wp_image_annotation_display');
			$dia_admin = get_option('wp_image_annotation_admin');
			$dia_thumbnail = get_option('wp_image_annotation_thumbnail');
			$dia_gravatar = get_option('wp_image_annotation_gravatar');
			$dia_gravatardefault = get_option('wp_image_annotation_gravatar_deafult');
			$dia_everypage = get_option('wp_image_annotation_everypage');
			$dia_comments = get_option('wp_image_annotation_comments');
			$dia_homepage = get_option('wp_image_annotation_homepage');
			$dia_archive = get_option('wp_image_annotation_archive');
			$dia_autoimageid = get_option('wp_image_annotation_autoimageid');
			$dia_mouseoverdesc = get_option('wp_image_annotation_mouseoverdesc');
			$dia_linkdesc = get_option('wp_image_annotation_linkdesc');
			$dia_postid = get_option('wp_image_annotation_postid');
			$dia_imgtag = get_option('wp_image_annotation_dia_imgtag');
		}
	?>
    ...
    <form name="dia_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
        ...
        <table class="form-table" width="100%">
            <tr>
                <th>
                    <label><?php _e("wp-image-annotation plugin status : " ); ?></label>
                </th>
              <td>
                  <?php
                    ...
                    <br />
                    <em>Enable or disable the wp-image-annotaion plugins although you want it to be Activate.</em>
              </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="dia_csscontainer" value="<?php echo ($dia_csscontainer == '') ? '.entry-content' : $dia_csscontainer; ?>" size="20"><?php _e(" ex: #entry-content, .entry-content" ); ?><br />
                    ...
                    <strong>Example (.entry-content)</strong><br />
                    <code>
            ...
            <tr>
              ...
              <td>
                  <?php
                    ...
                    <code>&lt;img id="img-6954914020" src="http://farm8.staticflickr.com/7077/6954914020_4b6cf96f03_z.jpg" /&gt;</code>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                  <?php
                    ...
                    <strong>Example (img-postid-6954914020)</strong><br />
                    <code>&lt;img id="img-12-6954914020" src="http://farm8.staticflickr.com/7077/6954914020_4b6cf96f03_z.jpg" /&gt;</code><br />
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                  <?php 
                    ...
                    <br />
                    <em>Yes will only allow admin to add image note, <br />or  No for every user to add image note.</em>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                  <?php 
                    ...
                    <br />
                    <em>Enable or disable  gravatar in image note.</em><br />
            ...
            <tr>
              ...
              <td>
                  <?php
                    ...
                    <br />
                    <em>If enable will sync with wordpress commenting system, new image note will add into comment as waiting approval.<br />
...
?>
    <div class="wrap">  
        ...
        if (isset($_POST['remove_selected_notes'])) {
			...
			if($_POST['s'] != '') {
				if( (get_option('wp_image_annotation_comments') == '0') ) {
        ...
        <form name="imagenotes" action="" method="post">
            ...
            if($items > 0) {
                    ...
                    $p->target("options-general.php?page=wp-Image-Annotation&tab=imagenotes");
