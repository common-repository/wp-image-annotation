...
(function($) {
    ...
    $.fn.annotateImage = function(options) {
		...
		// Add the canvas
        this.canvas = $('<div class="image-annotate-canvas"><img src="' + this.attr('src') + '" alt="" style="position:absolute; left:0; top:0;" /><div class="image-annotate-view image-annotate-loading"></div><div class="image-annotate-edit"><div class="image-annotate-edit-area"></div></div></div>');
    ...
    **/
    ...
    $.fn.annotateEdit = function(image, note) {
		...
		if(image.editable) {
			var form = $('<div id="image-annotate-edit-form" style="height:100px;"><div id="errormsg">You can start edit the note here.</div><form><textarea id="image-annotate-text" name="text" rows="3" cols="30" maxlength="140">' + this.note.text + '</textarea></form></div>');
		} else {
    ...
    $.fn.annotateView = function(image, note) {
	   ...
	   $("div.image-annotate-note").mouseover(function (e) {
         if($.contains(this, e.relatedTarget) == true) {
         $(this).show();
          }
         });
		 
		  
		 $("div.image-annotate-note").mouseout(function (e) {
